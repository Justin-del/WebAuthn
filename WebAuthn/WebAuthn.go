...
*/
func RegisterPublicKeyCredential(session *RegistrationSession, publicKeyCredential *RegistrationPublicKeyCredential, expectedOrigin string, functionToSaveCredentialsIntoDatabase func(credentialId []byte, credentialPublicKey []byte, transports []string, signCount uint32, userId string) bool) bool {
...
*/
func AuthenticatePublicKeyCredential(session *RegistrationSession, allowCredentials []Credential, publicKeyCredential *AuthenticationPublicKeyCredential, storedCredential *StoredCredential, expectedOrigin string) AuthenticationResult {
